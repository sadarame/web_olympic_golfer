<template>
  ...
  <div class="container mx-auto p-4 md:p-8 max-w-md card">
    <h1 class="text-3xl font-bold text-center mb-6 text-gray-800">アプリのレビュー ⭐️</h1>
    ...
    <div class="mb-8 p-6 bg-gray-50 rounded-lg shadow-md">
      ...
      <form @submit.prevent="submitReview">
        <div class="mb-4">
          ...
          <select id="rating" v-model="newReview.rating" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        ...
        <div class="mb-4">
          ...
          <textarea id="comment" v-model="newReview.comment" rows="5" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="アプリの感想や改善点などをご記入ください"></textarea>
        </div>
    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
      ...
      <div v-else>
        <div v-for="review in reviews" :key="review.id" class="border-b pb-4 mb-4 last:border-b-0 last:pb-0 last:mb-0">
